...
const Work = () => {
  return (
    ...
    <div className='container border-2 border-[#8A145E] rounded-2xl bg-gray-200 p-8'>
      <div className='flex space-x-8 pt-10 pb-5'>
        <img src="src/assets/luggage-02.svg" alt="" />
        <h1 className='font-jakarta font-extrabold text-[50px] text-[#021167] '>Work Experience</h1>
      </div>
