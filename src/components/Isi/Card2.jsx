...
const Card2 = () => {
  return (
    <div className='container bg-linear-to-t from-[#4545FF] to-[#021678] rounded-3xl w-fit h-fit place-items-center hover:scale-105 duration-300 ease-in-out cursor-pointer'>
        <div className='m-5'>
        <img className="md:h-160 w-150 h-full" src="src\assets\Card Components\photo2.svg" alt="" />
        <div>
            ...
            <div className='flex'>
                ...
                <img className='md:pl-20' src="src/assets/Card Components/next button.svg" alt="" />
            </div>
